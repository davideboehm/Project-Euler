...
namespace Problem5
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //eliminate all but the largest multiple of each prime (leave 16 since it is 2^4 but eliminate 2, 4, 6, 8, 12, 18, 20 since they have less twos in their prime factorization)
